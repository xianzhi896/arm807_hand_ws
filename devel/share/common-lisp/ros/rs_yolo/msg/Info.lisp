...
(cl:defmethod confidence-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs_yolo-msg:confidence-val is deprecated.  Use rs_yolo-msg:confidence instead.")
  (confidence m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Info>)))
  ...
  "648e54e2f1ebd287a27a11b0f48492ab")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Info)))
  "Returns md5sum for a message object of type 'Info"
  "648e54e2f1ebd287a27a11b0f48492ab")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Info>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%string classification~%float64 confidence~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Info)))
  "Returns full string definition for message of type 'Info"
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%string classification~%float64 confidence~%~%"))
