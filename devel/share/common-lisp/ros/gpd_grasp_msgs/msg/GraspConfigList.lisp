...
(cl:defclass <GraspConfigList> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (grasps
    :reader grasps
    :initarg :grasps
    :type (cl:vector gpd_grasp_msgs-msg:GraspConfig)
   :initform (cl:make-array 0 :element-type 'gpd_grasp_msgs-msg:GraspConfig :initial-element (cl:make-instance 'gpd_grasp_msgs-msg:GraspConfig))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GraspConfigList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GraspConfigList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gpd_grasp_msgs-msg:<GraspConfigList> is deprecated: use gpd_grasp_msgs-msg:GraspConfigList instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <GraspConfigList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_grasp_msgs-msg:header-val is deprecated.  Use gpd_grasp_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'grasps-val :lambda-list '(m))
(cl:defmethod grasps-val ((m <GraspConfigList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_grasp_msgs-msg:grasps-val is deprecated.  Use gpd_grasp_msgs-msg:grasps instead.")
  (grasps m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GraspConfigList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'grasps)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'gpd_grasp_msgs-msg:GraspConfig))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GraspConfigList>)))
  ...
  "gpd_grasp_msgs/GraspConfigList")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GraspConfigList)))
  "Returns string type for a message object of type 'GraspConfigList"
  "gpd_grasp_msgs/GraspConfigList")
