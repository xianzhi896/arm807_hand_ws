...
(cl:in-package gpd_grasp_msgs-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <GraspConfig>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GraspConfig)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gpd_grasp_msgs-msg:<GraspConfig> is deprecated: use gpd_grasp_msgs-msg:GraspConfig instead.")))

(cl:ensure-generic-function 'bottom-val :lambda-list '(m))
(cl:defmethod bottom-val ((m <GraspConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_grasp_msgs-msg:bottom-val is deprecated.  Use gpd_grasp_msgs-msg:bottom instead.")
  (bottom m))

(cl:ensure-generic-function 'top-val :lambda-list '(m))
(cl:defmethod top-val ((m <GraspConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_grasp_msgs-msg:top-val is deprecated.  Use gpd_grasp_msgs-msg:top instead.")
  (top m))

(cl:ensure-generic-function 'surface-val :lambda-list '(m))
(cl:defmethod surface-val ((m <GraspConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_grasp_msgs-msg:surface-val is deprecated.  Use gpd_grasp_msgs-msg:surface instead.")
  (surface m))

(cl:ensure-generic-function 'approach-val :lambda-list '(m))
(cl:defmethod approach-val ((m <GraspConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_grasp_msgs-msg:approach-val is deprecated.  Use gpd_grasp_msgs-msg:approach instead.")
  (approach m))

(cl:ensure-generic-function 'binormal-val :lambda-list '(m))
(cl:defmethod binormal-val ((m <GraspConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_grasp_msgs-msg:binormal-val is deprecated.  Use gpd_grasp_msgs-msg:binormal instead.")
  (binormal m))

(cl:ensure-generic-function 'axis-val :lambda-list '(m))
(cl:defmethod axis-val ((m <GraspConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_grasp_msgs-msg:axis-val is deprecated.  Use gpd_grasp_msgs-msg:axis instead.")
  (axis m))

(cl:ensure-generic-function 'sample-val :lambda-list '(m))
(cl:defmethod sample-val ((m <GraspConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_grasp_msgs-msg:sample-val is deprecated.  Use gpd_grasp_msgs-msg:sample instead.")
  (sample m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <GraspConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_grasp_msgs-msg:width-val is deprecated.  Use gpd_grasp_msgs-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <GraspConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gpd_grasp_msgs-msg:score-val is deprecated.  Use gpd_grasp_msgs-msg:score instead.")
  (score m))
